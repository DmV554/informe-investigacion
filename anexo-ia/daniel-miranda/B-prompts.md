...
- Prompts conversacionales adicionales del autor al agente (ampliación de la pool, guía de elección, estructuración de decisiones en tabla, corrección de estilo del borrador de 3.1): **[TODO Daniel: exportar o copiar las conversaciones a `registros/` y transcribir aquí los prompts literales]**. Resultados: `trabajo/3.1-alternativas/guia-eleccion-otros.md`, `propuesta-seleccion-anexo-D-2026-09-20.md`, `citas-pool-otros.csv` y `.bib`.
