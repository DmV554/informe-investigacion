...
- Prompts conversacionales adicionales del autor al agente (ampliación de la pool, guía de elección, estructuración de decisiones en tabla, corrección de estilo del borrador de 3.1). Resultados: `trabajo/3.1-alternativas/guia-eleccion-otros.md`, `propuesta-seleccion-anexo-D-2026-09-20.md` (eliminado del repositorio el 21-09-2026; su contenido quedó volcado en D.2--D.6), `citas-pool-otros.csv` y `.bib`.
