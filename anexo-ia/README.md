...
| 3 | Claudio Toledo | 3.1 Alternativas adicionales (búsqueda y verificación de candidatos); 3.2 Cuadro comparativo (filas Google, Cloudflare, Fastly, Deno/Vercel/Netlify y código abierto, y consolidación de la mitad de AWS y Azure); bibliografía de sus fuentes | 2 (búsqueda y verificación de datos en documentación oficial, traducción y resumen de fuentes, esquemas); 1 (volcado a LaTeX); 0 (dos párrafos de análisis de 3.2) | Claude Code 2.1.271 / 2.1.278 (`claude-opus-5`); Claude (Cowork, versión por confirmar) | `claudio-toledo/B-prompts.md`, `claudio-toledo/C-evidencia.md`, `claudio-toledo/registros/`, `claudio-toledo/registros/cowork/` |
| 4 | *(integrante)* | *(secciones)* | *(0–3 por sección)* | *(herramienta y versión)* | `<nombre-apellido>/…` |
