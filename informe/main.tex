...
\tabla{Criterios de inclusión y descarte aplicados a todos los candidatos}{criterios-busqueda}{|p{1.2cm}|p{6.6cm}|p{6.0cm}|}{%
    ...
    \filaTabla{I3 & Aporte diferencial: agrega al menos una dimensión no cubierta por las plataformas de la ficha en esa lista, entre estas cinco: unidad o modelo de cobro; mecanismo de aislamiento o de escala a cero; proveedor distinto de AWS, Google y Microsoft, u otra jurisdicción; acoplamiento a otro servicio del mismo ecosistema; límites en otro orden de magnitud (tiempo, payload, concurrencia). & Se identifica la dimensión en documentación oficial y se anota cuál. No cuentan popularidad, madurez percibida ni herramientas de desarrollo.}
    ...
    \filaTabla{X2 & Retirado, archivado, o con su función central en vista previa privada sin contratación general. La beta abierta no descarta. & Sitio o repositorio oficial: aviso de fin de soporte, archivo o vista previa privada, con fecha.}
}

\paragraph*{Regla de desempate.} Se activa solo cuando, tras aplicar X1, X2, I1, I2 e I3, quedan más de dos candidatos en una lista y dos de ellos aportan el mismo tipo de contraste frente a las plataformas de la ficha. Se retiene el que resulte favorecido por el primer paso que los separe, en este orden: (1)~precio de lista vigente publicado frente a solo por cotización o precio ausente; (2)~límites técnicos publicados frente a no publicados; (3)~disponibilidad general frente a beta, beta abierta o vista previa pública; (4)~documentación oficial más específica para la lista evaluada (página de límites o de precios del propio servicio, no solo la descripción general). Un candidato descartado por esta regla se registra como ``desempate, paso~$n$'', no con un código de puerta.
...
{\scriptsize
\begin{longtable}{|p{2.7cm}|p{2.7cm}|p{1.5cm}|p{2.5cm}|p{4.8cm}|}
    \hline
    \textbf{Candidato} & \textbf{Fuente oficial} & \textbf{Fecha} & \textbf{Resultado (criterio)} & \textbf{Motivo / qué aporta} \\
    \hline
    \endhead
    Oracle Cloud Infrastructure Functions & \parencite{oracle2026ocifunctions,oracle2026ocifunctionslimits} & 2026-09-20 &  &  \\ \hline
    Alibaba Cloud Function Compute 3.0 & \parencite{alibaba2026fcpayg,alibaba2026fclimits,alibaba2026fctrial} & 2026-09-20 &  &  \\ \hline
    IBM Cloud Code Engine (functions) & \parencite{ibm2026codeenginelimits,ibm2026codeenginesample} & 2026-09-20 &  &  \\ \hline
    Scaleway Serverless Functions & \parencite{scaleway2026serverlesspricing,scaleway2026functionslimits} & 2026-09-20 &  &  \\ \hline
    Huawei Cloud FunctionGraph & \parencite{huawei2026functiongraphprice,huawei2026functiongraphlimits} & 2026-09-20 &  &  \\ \hline
    Tencent Cloud SCF & \parencite{tencent2026scfpricing,tencent2026scffreetier,tencent2026scfquotas} & 2026-09-20 &  &  \\ \hline
    & & & & \\ \hline
\end{longtable}
}
...
\begin{longtable}{|p{2.7cm}|p{2.7cm}|p{1.5cm}|p{2.5cm}|p{4.8cm}|}
    ...
    \hline
    \endhead
    Fly.io (Machines) & \parencite{fly2026pricing} & 2026-09-20 &  &  \\ \hline
    Railway & \parencite{railway2026pricing} & 2026-09-20 &  &  \\ \hline
    Render & \parencite{render2026pricing,render2026limits,render2026faq} & 2026-09-20 &  &  \\ \hline
    Scaleway Serverless Containers & \parencite{scaleway2026serverlesspricing,scaleway2026containerslimits} & 2026-09-20 &  &  \\ \hline
    Koyeb & \parencite{koyeb2026pricing,koyeb2026instances} & 2026-09-20 &  &  \\ \hline
    DigitalOcean App Platform & \parencite{do2026appplatformpricing,do2026appplatformlimits,do2026appplatformstz} & 2026-09-20 &  &  \\ \hline
    & & & & \\ \hline
\end{longtable}
}
...
\begin{longtable}{|p{2.7cm}|p{2.7cm}|p{1.5cm}|p{2.5cm}|p{4.8cm}|}
    ...
    \hline
    \endhead
    Akamai EdgeWorkers & \parencite{akamai2026edgeworkerslimits,akamai2026edgeworkersbilling} & 2026-09-20 &  &  \\ \hline
    Supabase Edge Functions & \parencite{supabase2026edgefunctionslimits,supabase2026edgefunctionsbilling} & 2026-09-20 &  &  \\ \hline
    Bunny Edge Scripting & \parencite{bunny2026scriptingpricing,bunny2026scriptinglimits} & 2026-09-20 &  &  \\ \hline
    Azion Edge Functions & \parencite{azion2026pricing,azion2026functionslimits} & 2026-09-20 &  &  \\ \hline
    Fermyon Cloud (Spin gestionado) & \parencite{fermyon2026cloudpricing,fermyon2026cloudfaq} & 2026-09-20 &  &  \\ \hline
    Azure Front Door (Rules Engine / Edge Actions) & \parencite{microsoft2026frontdooredgeactions} & 2026-09-20 & Descartado (I2) & Rules Engine no ejecuta código del usuario (condiciones más acciones predefinidas); Edge Actions sí, pero en vista previa. \textit{[TODO Daniel: confirmar redacción]} \\ \hline
    & & & & \\ \hline
\end{longtable}
}
...
Ya nombra la ficha: Knative, OpenFaaS, KEDA, Fermyon Spin / SpinKube, wasmCloud, Wasmtime. Cada dato de precio se etiquetó como precio de lista, solo por cotización o no publicado; cada límite como publicado o no publicado; la URL y la fecha de consulta de cada fuente están en la entrada bibliográfica citada.
...
\begin{longtable}{|p{2.7cm}|p{2.7cm}|p{1.5cm}|p{2.5cm}|p{4.8cm}|}
    ...
    \hline
    \endhead
    Apache OpenWhisk & \parencite{openwhisk2026product,openwhisk2026limits} & 2026-09-20 &  &  \\ \hline
    Fission & \parencite{fission2026executors,fission2026releases} & 2026-09-20 &  &  \\ \hline
    Nuclio & \parencite{nuclio2026architecture,nuclio2026triggers,nuclio2026kafka,nuclio2026releases} & 2026-09-20 &  &  \\ \hline
    Fn Project & \parencite{fnproject2026product,oracle2026fnoverview} & 2026-09-20 &  &  \\ \hline
    WasmEdge & \parencite{wasmedge2026site,cncf2026wasmedge} & 2026-09-20 &  &  \\ \hline
    Direktiv & \parencite{direktiv2026docs,direktiv2026github,direktiv2026landscape} & 2026-09-20 &  &  \\ \hline
    Kubeless & \parencite{vmware2026kubeless} & 2026-09-20 & Descartado (X2) & Repositorio archivado por VMware; el README declara que no se mantiene. Fecha de archivo: \textit{[TODO Daniel: banner de GitHub]} \\ \hline
    riff & \parencite{projectriff2021final} & 2026-09-20 & Descartado (X2) & Proyecto declarado terminado el 13 de marzo de 2021. \\ \hline
    IronFunctions & \parencite{oracle2019fnproject} & 2026-09-20 & Descartado (X1) & Sucedido por Fn Project (mismo equipo, bifurcación en Oracle, 2017--2019); se evalúa Fn en su lugar. \\ \hline
    & & & & \\ \hline
\end{longtable}
}
...
\begin{longtable}{|p{2.7cm}|p{2.7cm}|p{1.5cm}|p{2.5cm}|p{4.8cm}|}
    ...
    \hline
    \endhead
    PlanetScale & \parencite{planetscale2026pricing,planetscale2026hobbydeprecate} & 2026-09-20 &  &  \\ \hline
    Turso (libSQL) & \parencite{turso2026pricing,turso2026usage} & 2026-09-20 &  &  \\ \hline
    Upstash Redis & \parencite{upstash2026redisbilling,upstash2026redispricing} & 2026-09-20 &  &  \\ \hline
    CockroachDB Cloud (Basic) & \parencite{cockroach2026basicproduct,cockroach2026pricing} & 2026-09-20 &  &  \\ \hline
    Firestore & \parencite{firestore2026pricing,firestore2026quotas,firestore2026enterprisepricing} & 2026-09-20 &  &  \\ \hline
    MongoDB Atlas Serverless & \parencite{mongodb2026flexmigration} & 2026-09-20 & Descartado (X2) & Sin creación de instancias desde febrero de 2025; fin de soporte el 22 de enero de 2026; migradas a Free, Flex o Dedicated. \\ \hline
    & & & & \\ \hline
\end{longtable}
}
...
% TODO. Solo si para alguna lista no se encontraron al menos dos alternativas
% que cumplan los criterios: declararlo expresamente aquí, con las fuentes
% consultadas y la fecha de cierre de la búsqueda (punto 4, "Declaración
% cuando no hay más"). Si todas las listas tienen dos o más, dejar una frase
% que lo diga y remitir a las tablas D.2 a D.6.
