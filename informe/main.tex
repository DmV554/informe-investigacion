...
%  definitivo acordado por el equipo (ver TERABYTE-TI05-Guia-del-equipo.md).
...
\phantomsection
\addcontentsline{toc}{section}{Anexo A: Declaración de uso de inteligencia artificial}
\section*{Anexo A: Declaración de uso de inteligencia artificial}
...
\phantomsection
\addcontentsline{toc}{section}{Anexo B: Código y mediciones de la prueba de concepto}
\section*{Anexo B: Código y mediciones de la prueba de concepto}
...
\phantomsection
\addcontentsline{toc}{section}{Anexo C: Planilla del modelo de costos}
\section*{Anexo C: Planilla del modelo de costos}
...
\phantomsection
\addcontentsline{toc}{section}{Anexo D: Búsqueda documentada de alternativas}
\section*{Anexo D: Búsqueda documentada de alternativas}
...
%% Redacción 100 % humana (punto 6.1). Numeración B1, B2, ...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
